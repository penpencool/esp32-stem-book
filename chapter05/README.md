...
- ใช้งานง่ายกว่า ราคาไม่แพงกว่ามาก
```
...
**ตอบ:** DHT11 ใช้เวลาประมาณ 1-2 วินาทีในการ "ตื่นตัว" และเตรียมพร้อมวัดค่าหลังจากเปิดไฟ�้า ถ้าเราอ่านค่าทันทีหลังจากเริ่มทำงาน ค่าที่ได้จะไม่ถูกต้อง หรืออาจได้ค่า NaN ก็ได้ นี่เป็นข้อจำกัดของตัวเซ็นเซอร์เอง ไม่ใช่ปัญหาจากโค้ดของเรา หลังจากอ่านครั้งแรกแล้ว ค่าถัดไปจะอ่านได้เร็วปกติ (ทุก 2-3 วินาทีก็พอ)
