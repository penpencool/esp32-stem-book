...
3. พิมพ์ **"IRremoteESP8266"** ในช่องค้นหา
4. เลือก **IRremoteESP8266** โดย Armin Joachimsmeyer
5. กด **Install**

> ⚠️ **หมายเหตุ:** Library ตัวนี้ชื่อ ESP8266 แต่ใช้กับ ESP32-C3 ได้เลย! เพราะ ESP32-C3 มาจากตระกูล Espressif เหมือนกัน

#### ขั้นตอนที่ 2: อัปโหลดโค้ดถอดรหัส

ไปที่ **File → Examples → IRremoteESP8266 → IRrecvDumpV2**
...
✅ **ใช้ Library IRremoteESP8266** ถอดรหัสและใช้งาน IR ได้ง่ายมาก  
